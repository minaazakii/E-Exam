            ...
            <div class="container-fluid">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Here is List of MCQs</h6>
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                @if(auth()->user()->level == $mcq->getLevel() || auth()->user()->level == 0  )
                                                <th scope="row">{{ $index+1 }}</th>
                                                <td>{{ $mcq->Question }}</td>
                                                <td>{{ $mcq->correctAns }}</td>
                                                <td>{{ $mcq->getSubject() }}</td>
                                                <td>{{ $mcq->getLevel() }}</td>
                                                @endif()
                                            </tr>
                                            @endforeach
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">True and False Questions</h4>
                                <h6 class="card-subtitle">Here is List of True and False Questions</h6>
                                <div class="table-responsive">
                                    <table class="table">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                @if(auth()->user()->level == $tf->getLevel() || auth()->user()->level == 0  )
                                                <th scope="row">{{ $index+1 }}</th>
                                                <td>{{ $tf->Question }}</td>
                                                <td>{{ $tf->correctAns }}</td>
                                                <td>{{ $tf->getSubject() }}</td>
