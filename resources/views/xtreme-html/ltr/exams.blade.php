                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="/img/logo.gif" alt="homepage" class="dark-logo" />
                            <!-- Light Logo icon -->
                            ...
                            <div class="table-responsive">
                                <table class="table v-middle">
                                    ...
                                    <tbody>
                                        ...
                                        @if(auth()->user()->level == $exam->level || auth()->user()->level == 0)
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="m-r-10"><a
                                                    ...
                                                    <div class="">
                                                       <label for="">{{ $exam->subjectName }}</label>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                               <label for="">{{ $exam->questionCount }}</label>
                                            </td>

                                            <td>
                                                <label for="">{{ $exam->doctorName }}</label>
                                            </td>

                                            <td>
                                                <label for="">{{ $exam->totalMark }}</label>
                                            </td>
                                            ...
                                            <td>
                                                @if(auth()->user()->role_id == 3)
                                                <h5 class="m-b-0">
                                                    <a href="{{ route('examIndex',$exam->id) }}" type="submit" class="btn btn-success">Take Quiz</a>
                                                </h5>
                                                @else
                                                <h5 class="m-b-0">
                                                    <a href="{{ route('questionType',$exam->id) }}" type="submit" class="btn btn-success">Add Questions?</a>
                                                </h5>
                                                @endif
                                            </td>
                                        </tr>
