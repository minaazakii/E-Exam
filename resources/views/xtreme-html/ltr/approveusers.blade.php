                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Here is List of Teachers in your Faculty</h6>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $user->email }}</td>
                                                <td>
                                                    <form class="d-inline" action="{{ route('approveUser',$user->id) }}" method="POST">
                                                        @csrf
                                                        <button type="submit" class="d-inline btn btn-success">yes</button>
                                                    </form>
