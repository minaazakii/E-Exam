        ...
        <section class="signup">
            <div class="student-signup">
                ...
                @endif
                    ...
                    <form action="{{ route('regStudent') }}" method="POST" enctype="multipart/form-data" >
                        @csrf
                        ...
                        <input name="faculty" type="text" id="faculty "placeholder="Faculty" class="input">
                        @error('faculty')
                            <div class="text-danger">
                                {{ $message }}
                            </div>
                        ...
                        <select class="input" name="level" id="">
                            <option class="text-secondary text-center" disabled selected hidden  >select level</option>
                            @for ($i = 1 ; $i<=4 ; $i++)
